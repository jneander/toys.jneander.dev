...
export const CREATURE_GRID_TILE_HEIGHT = 30
...
export const VIEW_PADDING_START_Y = 40
export const VIEW_PADDING_END_X = 40
export const VIEW_PADDING_END_Y = 40
...
export const CREATURE_COLLECTION_VIEW_HEIGHT =
  GRID_AREA_HEIGHT + VIEW_PADDING_START_Y + VIEW_PADDING_END_Y // 830
