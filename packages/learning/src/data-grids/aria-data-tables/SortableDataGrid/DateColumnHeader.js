...
export default class DateColumnHeader extends Component {
  constructor(props) {
    super(props)
  ...
  handleToggleSort() {
    this.props.onSort('date', this.props.sortDirection === 'ascending' ? 'descending' : 'ascending')
  }

  render() {
    const classes = [styles.ColumnHeader]
    if (this.props.sortColumn === 'date') {
