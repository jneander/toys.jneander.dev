...
export default class DescriptionCell extends PureComponent {
  constructor(props) {
    super(props)
  ...
  render() {
    ...
    return (
      <td className={`${styles.Cell} ${sortableStyles.Cell}`}>
        <div className="editable-text">
          {this.state.isEditing ? (
            <input
              className={sortableStyles.EditTextInput}
            ...
            <span
              className={sortableStyles.EditTextButton}
